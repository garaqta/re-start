...
let defaultSettings = {
    ...
    linkIconMode: 'icons',
    links: [
        { title: 'gmail', url: 'https://mail.google.com', icon: 'gmail', hotkey: 'g' },
        {
            title: 'calendar',
        ...
        { title: 'docs', url: 'https://docs.google.com', icon: 'googledocs', hotkey: 'o' },
        { title: 'github', url: 'https://github.com', icon: 'github', hotkey: 'h' },
        { title: 'slack', url: 'https://slack.com', icon: '', hotkey: 's' },
        { title: 'keep', url: 'https://keep.google.com', icon: 'googlekeep', hotkey: 'k' },
        {
            title: 'leetcode',
        ...
        { title: 'claude', url: 'https://claude.ai', icon: 'claude', hotkey: 'a' },
        {
            title: 'gemini',
        ...
        { title: 'chatgpt', url: 'https://chatgpt.com/', icon: '', hotkey: 'C' },
        { title: 'youtube', url: 'https://youtube.com', icon: 'youtube', hotkey: 'y' },
        { title: 'reddit', url: 'https://reddit.com', icon: 'reddit', hotkey: 'r' },
        { title: 'twitter', url: 'https://x.com', icon: 'x', hotkey: 'x' },
        { title: 'feedly', url: 'https://feedly.com', icon: 'feedly', hotkey: 'f' },
    ],
